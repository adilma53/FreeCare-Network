	...
	<div
		...
		<div class="p-6 space-y-4 md:space-y-6 sm:p-8">
			<h1
				...
				Create your new account in FreeCare Network
			</h1>
			<form class="space-y-4 md:space-y-6" action="?/signup">
				<div>
					<label for="fullname" class="block text-base font-medium text-surface-700 dark:text-surface-300 mb-3"
						>Your full name</label>
					<input
						type="name"
						name="full_name"
						class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-surface-700 dark:border-surface-400 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
				...
				<p class="text-sm font-light text-gray-500 dark:text-gray-400">
					You have an account already? <a
						href="/auth/login"
						class="font-medium text-primary-600 hover:underline dark:text-primary-500">Log up</a>
				</p>
			</form>
		</div>
	</div>
