    ...
    <div className="flex items-center justify-center p-3">
      <Card
        ...
        <CardBody className="space-y-5">
          <Image src={food} alt="pic of food" className="object-cover object-center w-full h-64 overflow-visible rounded-lg" />
          <div>
            <h1 className="mt-4 text-xl font-bold text-gray-800 dark:text-white">Free Meals</h1>
