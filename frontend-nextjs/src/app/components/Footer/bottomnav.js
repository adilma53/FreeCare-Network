export function BottomNav() {
  <div className="fixed bottom-0 left-0 z-50 w-full h-16 bg-gray-50 border-t border-gray-400 dark:bg-gray-700 dark:border-gray-600">
    <div className="grid h-full max-w-lg grid-cols-3 mx-auto font-medium">
      <button className="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-100 dark:hover:bg-gray-600 group">
        <svg
